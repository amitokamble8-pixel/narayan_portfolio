...
export function Home() {
  usePageMeta(
    `${SITE} | IB Student • Economics, Communication & Leadership`,
  ...
  return (
    <>
      ...
      <section className="section">
        ...
        <MoreLink to="/awards">Every Achievements</MoreLink>
      </section>

      <section className="section">
        <SectionHead title="Research & Programmes" eyebrow="Publications" />
        <div className="grid-2">
          {EXPERIENCE.filter((e) => e.featured).slice(0, 2).map((e, i) => (
            <Reveal key={e.slug} delay={i * 90}><ExperienceCard e={e} /></Reveal>
          ))}
        </div>
        <MoreLink to="/work">All Research & Programmes</MoreLink>
      </section>
      ...
      <section className="section">
        <SectionHead title="Activities & Participations" eyebrow="Chess · Programmes" />
        <Reveal>
        ...
        <MoreLink to="/volunteering">All Activities & Participations </MoreLink>
      </section>
...
export function About() {
  ...
  return (
    <section className="section">
      <PageHead title="About" eyebrow="Economics • Communication & Leadership" />
      ...
      <SubHead title="Education" eyebrow="IB Student" />
      <div className="stack">
        {EDUCATION.map((e, i) => (
...
export function Work() {
  usePageMeta(`Research & Programmes | ${SITE}`, "Research assistantships, work experience, and teaching roles.");
  return (
    <section className="section">
      <PageHead title="Research & Programmes" eyebrow="Publications" />
      <div className="grid-2">
        {EXPERIENCE.map((e, i) => (
...
export function Projects() {
  ...
  return (
    <section className="section">
      <PageHead title="Projects" eyebrow="Built & Presented" />
      <div className="grid-2">
        {PROJECTS.map((p, i) => (
...
export function Volunteering() {
  usePageMeta(`Activities & Participations | ${SITE}`, "Founding a machine learning club, teaching summer band, and community volunteering.");
  return (
    <section className="section">
      <PageHead title="Activities & Participations" eyebrow="Chess · Programmes" />
      <Reveal>
        <div className="vol-panel">
          <div className="vol-stats">
            {VOLUNTEER.stats.map((s) => (
...
export function Sports() {
  usePageMeta(`Chess Journey | ${SITE}`, "Marching band, saxophone ensemble, concert band, hackathons, and game jams.");
  return (
    <section className="section">
      <PageHead title="Chess Journey" eyebrow="Beyond Academics" />
